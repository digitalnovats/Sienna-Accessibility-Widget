...
export default function renderMenu() {
  ...
  $container.querySelectorAll(".asw-menu-reset").forEach((el) => el.addEventListener("click", reset));
  ...
  $menu.querySelectorAll(".asw-btn").forEach((el: HTMLElement) => {
    el.addEventListener("click", () => {
      ...
      if (el.classList.contains("asw-filter")) {
        $menu.querySelectorAll(".asw-filter").forEach((el: HTMLElement) => el.classList.remove("asw-selected"));
